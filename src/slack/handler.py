...
def run_betterbrain_cascade(question: str, betterbrain_config) -> Tuple[Optional[str], str]:
    ...
    answer, status = _run_claude(
        ...
        "never mentions auto-approval.\n"
        "D. Never widen a source's scope. A Classic record does not answer a NextGen or "
        "anytime-conversation question; a BambooHR-specific field mapping does not "
        "establish generic HRIS behavior. If your source covers a narrower case than the "
        "question, say so and answer only the narrow part. Broken twice on 2026-07-22, "
        "once across Classic/anytime and once across HRIS providers.\n"
        "\n"
